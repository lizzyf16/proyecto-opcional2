  ...
  <div id="app" class="py-3">
    ...
    <main class="container">
      ...
      <section class="row justify-content-center g-3">
        <div class="col-12 col-md-6 col-lg-3" v-for="producto in productos" :key="producto.id">
          ...
          productos: [
              {
                  ...
                  descripcionLarga: "Zapatilla de caballero 1"
              },
              {
                  id: 2,
                  nombre: "Producto 2",
                  ...
                  descripcionLarga: "Zapatilla de caballero 2"
              },
              {
                  id: 3,
                  nombre: "Producto 3",
                  ...
                  descripcionLarga: "Zapatilla de caballero 3"
              },
              {
                  id: 4,
                  nombre: "Producto 4",
                  ...
                  pathImg: "./img/zapatilla1.jpg",
                  descripcionLarga: "Zapatilla de caballero 4"
              },
          ],
          currentProducto: {},
      };
